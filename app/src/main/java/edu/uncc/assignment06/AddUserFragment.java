...
public class AddUserFragment extends Fragment {
        ...
        binding.buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty()){
                    ...
                    Toast.makeText(getActivity(), "Select an age group", Toast.LENGTH_SHORT).show();
                } else if (selectedMood == null) {
                    Toast.makeText(getActivity(), "Select a mood", Toast.LENGTH_SHORT).show();
                } else {
                    // Call the API to add a new user
                    addNewUser(name, String.valueOf(selectedMood.getId()), String.valueOf(selectedAgeGroup.getId()));
                }
            }
        });
    }
    ...
    private void addNewUser(String name, String moodID, String ageGroupID) {
